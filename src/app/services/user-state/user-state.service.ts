...
export class UserStateService {
    ...
    constructor() {
        this._userList = [
            { id: '52ec7d7a-9a06-4b33-a57d-7ff32fe6d48c', username: 'Doctor.Strange@gmail.com', password: 'abc123!!', userType: UserType.basic, lastName: 'Strange', firstName: 'Doctor', accountBalance: 125043 },
            { id: '44dbbd9a-e057-4a60-be06-811317c33635', username: 'Scott.Lang@gmail.com', password: 'abc123!!', userType: UserType.basic, lastName: 'Lang', firstName: 'Scott', accountBalance: 12354 },
            ...
            { id: '01dc04b3-463b-4892-b8b1-15f4f5f92753', username: 'Bruce.Banner@gmail.com', password: 'abc123!!', userType: UserType.admin, lastName: 'Banner', firstName: 'Bruce', },
            { id: '4049f54a-43cd-435e-9312-9e2964bb3342', username: 'Steve.Rogers@gmail.com', password: 'abc123!!', userType: UserType.super, lastName: 'Rogers', firstName: 'Steve' },
            { id: '8e1f391b-c383-4f1b-87c9-cd2dd2a687e3', username: 'Natasha.Romanoff@gmail.com', password: 'abc123!!', userType: UserType.super, lastName: 'Romanoff', firstName: 'Natasha' }
        ];
    }
